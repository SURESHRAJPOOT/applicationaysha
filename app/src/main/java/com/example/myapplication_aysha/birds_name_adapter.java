...
public class birds_name_adapter extends RecyclerView.Adapter<birds_name_adapter.ViewHolder> {
    Context mycontext;
    ArrayList<Object> model;

    public birds_name_adapter(Context mycontext, ArrayList<Object> model) {
    ...
    @NonNull
    @Override
    public birds_name_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview = LayoutInflater.from(mycontext).inflate(R.layout.home_recyclerview_layout,null,true);
        return new birds_name_adapter.ViewHolder(myview);
    }
    ...
    public void onBindViewHolder(@NonNull birds_type_adapter.ViewHolder holder, int position) {
